<?php if (!defined('THINK_PATH')) exit();?><html>
	...
	<body>
		...
		<form action="/thinkphp323/index.php/Home/Index/savecode" method="post" enctype="multipart/form-data">
		    <div class="form-group">
			    <label for="exampleInputEmail1">邮箱</label>
			    <input type="email" class="form-control" id="exampleInputEmail1" name="email" aria-describedby="emailHelp" placeholder="邮箱" value="<?php echo ($email); ?>" disabled>
			    <small id="emailHelp" class="form-text text-muted">我们绝不会与其他人分享您的电子邮件。</small>
			  </div>
			  <div class="form-group">
			    <label for="exampleInputPassword1">验证码</label>
			    <input type="text" class="form-control" id="exampleInputPassword1" name="code" placeholder="验证码">
			  </div>
